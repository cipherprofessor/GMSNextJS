...
const sidebarItems = [
  ...
  { href: "/report", icon: MapPin, label: "Passes" },
  { href: "/collect", icon: Trash, label: "Staff Management" },
  { href: "/rewards", icon: Coins, label: "Student Management" },
  { href: "/leaderboard", icon: Medal, label: "Visitors" },
]
