    ...
    <div className="p-8 max-w-4xl mx-auto">
      ...
      <div className="bg-white p-8 rounded-2xl shadow-lg mb-12 mt-2">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          {/* Name */}
          {/* <div>
            <label htmlFor="location" className="block text-sm font-medium text-gray-700 mb-1">Visitor Name</label>
            {isLoaded ? (
              <StandaloneSearchBox
                onLoad={onLoad}
              ...
              >
                <input
                  ...
                  placeholder="Please Enter The Visitors Name"
                />
              </StandaloneSearchBox>
            ) : (
              <input
      ...
      {/* <h2 className="text-3xl font-semibold mb-6 text-gray-800">Recent Passes</h2> */}
